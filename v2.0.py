...
from PySide6.QtWidgets import (
    ...
    QSpinBox, QStyle, QStyleOptionButton, QSizePolicy, QSpacerItem, QFrame
)
...
class PlottingApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("多功能繪圖工具-V2.0")
    ...
    def init_ui(self):
        ...
        # 繪圖參數設定
        self.settings_group = QGroupBox("圖表設定")
        ...
        self.settings_layout.addWidget(QLabel("圖表標題:"), 0, 0)
        self.settings_layout.addWidget(self.title_input, 0, 1)
        ...
        self.settings_layout.addWidget(QLabel("X 軸標籤:"), 1, 0)
        self.settings_layout.addWidget(self.x_label_input, 1, 1)
        ...
        self.settings_layout.addWidget(QLabel("Y 軸標籤:"), 2, 0)
        self.settings_layout.addWidget(self.y_label_input, 2, 1)
        ...
        self.settings_layout.addWidget(QLabel("圖例名稱:"), 3, 0)
        self.settings_layout.addWidget(self.legend_input, 3, 1)
        ...
        self.settings_layout.addWidget(QLabel("圖例文字大小:"), 4, 0)
        self.settings_layout.addWidget(self.legend_size_spinbox, 4, 1)
        ...
        self.settings_layout.addLayout(data_label_layout, 5, 0, 1, 2)
        self.settings_layout.addLayout(data_label_size_layout, 6, 0, 1, 2)
        
        interval_layout = QHBoxLayout()
        self.settings_layout.addWidget(QLabel("X/Y 軸間隔:"), 7, 0)
        ...
        self.settings_layout.addLayout(interval_layout, 7, 1)
        
        decimal_layout = QHBoxLayout()
        self.settings_layout.addWidget(QLabel("小數點位數:"), 8, 0)
        ...
        self.settings_layout.addLayout(decimal_layout, 8, 1)

        plot_settings_layout.addWidget(self.settings_group)
        
        # 動態顯示的繪圖樣式設定
        self.style_group = QGroupBox("繪圖樣式設定")
        ...
        self.style_layout.addWidget(QLabel("圖表顏色:"), 0, 0)
        self.style_layout.addWidget(self.plot_color_btn, 0, 1)
        ...
        self.style_layout.addWidget(QLabel("邊框粗度:"), 1, 0)
        self.style_layout.addWidget(self.border_width_spinbox, 1, 1)
        
        self.border_color_btn = QPushButton("選擇顏色")
        self.border_color_btn.clicked.connect(lambda: self.pick_color("border"))
        self.style_layout.addWidget(QLabel("邊框顏色:"), 2, 0)
        self.style_layout.addWidget(self.border_color_btn, 2, 1)

        plot_settings_layout.addWidget(self.style_group)
        
        # 背景與座標軸設定
        axis_style_group = QGroupBox("背景與座標軸設定")
        ...
        axis_style_layout.addWidget(QLabel("背景顏色:"), 0, 0)
        axis_style_layout.addWidget(self.bg_color_btn, 0, 1)
        
        axis_style_layout.addWidget(QLabel("X 軸標籤:"), 1, 0)
        ...
        axis_style_layout.addWidget(QLabel("大小:"), 2, 1)
        axis_style_layout.addWidget(self.y_label_size_spinbox, 2, 2)
        self.y_label_bold_checkbox = QCheckBox("粗體")
        self.y_label_bold_checkbox.toggled.connect(self.update_plot_with_timer)
        axis_style_layout.addWidget(self.y_label_bold_checkbox, 2, 3)
        self.y_label_color_btn = QPushButton("顏色")
        self.y_label_color_btn.clicked.connect(lambda: self.pick_color("y_label"))
        axis_style_layout.addWidget(self.y_label_color_btn, 2, 4)
        
        tick_size_layout = QHBoxLayout()
        axis_style_layout.addWidget(QLabel("X/Y 刻度大小:"), 3, 0)
        ...
        axis_style_layout.addLayout(tick_size_layout, 3, 1, 1, 4)
        ...
        axis_style_layout.addWidget(QLabel("座標軸邊框粗度:"), 4, 0)
        axis_style_layout.addWidget(self.axis_border_width_spinbox, 4, 1, 1, 4)
    ...
    def setup_dynamic_widgets(self):
        ...
        self.style_layout.addWidget(self.line_width_label, 3, 0)
        self.style_layout.addWidget(self.line_width_spinbox, 3, 1)
        ...
        self.style_layout.addWidget(self.bar_width_label, 3, 0)
        self.style_layout.addWidget(self.bar_width_spinbox, 3, 1)
        ...
        self.style_layout.addWidget(self.point_size_label, 3, 0)
        self.style_layout.addWidget(self.point_size_spinbox, 3, 1)
        ...
        self.style_layout.addWidget(self.linestyle_label, 4, 0)
        self.style_layout.addWidget(self.linestyle_combo, 4, 1)
        ...
        self.style_layout.addWidget(self.marker_label, 4, 0)
        self.style_layout.addWidget(self.marker_combo, 4, 1)
    ...
    def toggle_plot_settings(self):
        ...
        # 折線圖設定
        self.line_width_label.setVisible(is_line_checked)
        self.line_width_spinbox.setVisible(is_line_checked)
        self.linestyle_label.setVisible(is_line_checked)
        ...
        # 顯示或隱藏數據標籤選項
        data_labels_visible = is_line_checked or is_scatter_checked or is_bar_checked
        self.show_data_labels_checkbox.setVisible(data_labels_visible)
        self.show_x_labels_checkbox.setVisible(data_labels_visible)
        self.show_y_labels_checkbox.setVisible(data_labels_visible)
        self.data_label_size_spinbox.setVisible(data_labels_visible)
    ...
    def update_plot(self):
        ...
        if legend_label:
            ...
            # 如果圖例名稱與預設的圖表類型名稱一致，則使用使用者輸入的名稱
            if self.line_checkbox.isChecked() and "折線圖" in unique_labels:
                labels = [legend_label if l == "折線圖" else l for l in labels]
            if self.scatter_checkbox.isChecked() and "散佈圖" in unique_labels:
                labels = [legend_label if l == "散佈圖" else l for l in labels]
            if self.bar_checkbox.isChecked() and "長條圖" in unique_labels:
                labels = [legend_label if l == "長條圖" else l for l in labels]
            ...
            self.legend = self.ax.legend(unique_handles, unique_labels, prop={'size': self.legend_size_spinbox.value()}, draggable=True)
            if self.legend:
